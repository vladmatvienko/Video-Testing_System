...
public class VideoPlayerController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        String path = new File("C:\\Users\\glebv\\Desktop\\Проекты Джава\\Эксперименты\\demo2\\src\\main\\java\\VideoLibrary\\" + HelloApplication.VideoName[HelloApplication.ID] + ".MP4").getAbsolutePath();
        ...
        String filePath = "C:\\Users\\glebv\\Desktop\\Проекты Джава\\Эксперименты\\demo2\\src\\main\\java\\VideoLibrary\\" + HelloApplication.VideoName[HelloApplication.ID] + "Остановки.txt";
    ...
    public void PlayQuestion (ActionEvent event){
        ...
        if(SignInController.loginOfCurrentUser.equals("admin")){
            HelloApplication.switchToNewWindow("QestionAdmin.fxml");
        }
        else {
        HelloApplication.switchToNewWindow("Question");}
    }
